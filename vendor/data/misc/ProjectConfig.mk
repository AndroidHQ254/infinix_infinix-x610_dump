...
CUSTOM_BUILD_VERNO = CY-X610-H651-A
...
#ITD:modify XLYLHLWY-2850 by wei.wang2 20190305 start
CUSTOM_SKIN_COLOR_COMPATIBLE = yes
CUSTOM_HAL_IMGSENSOR = s5k3p9sx_mipi_raw s5k3p9sxb_mipi_raw s5k3p9sp_mipi_raw s5k3p9spb_mipi_raw sp250a_mipi_raw sp250ab_mipi_raw gc8034_mipi_raw gc8034b_mipi_raw
#ITD:modify XLYLHLWY-2850 by wei.wang2 20190305 end
CUSTOM_TRAN_CAM_MATERIAL_CODE = s5k3p9sx_17201547 s5k3p9_17201557 sp250a_17201529 gc8034w_17201535
#ITD:modify XLYLHLWY-2850 by wei.wang2 20190305 start
CUSTOM_TRAN_HAL_MAIN3_IMGSENSOR = gc8034_mipi_raw gc8034b_mipi_raw
#ITD:modify XLYLHLWY-2850 by wei.wang2 20190305 end
...
#ITD:modify XLYLHLWY-2850 by wei.wang2 20190305 start
CUSTOM_HAL_SUB_IMGSENSOR = s5k3p9sp_mipi_raw s5k3p9spb_mipi_raw
#ITD:modify XLYLHLWY-2850 by wei.wang2 20190305 end
...
#ITD: Modify By ISP-CAM Start
CUSTOM_KERNEL_IMGSENSOR = s5k3p9sx_mipi_raw s5k3p9sp_mipi_raw sp250a_mipi_raw gc8034_mipi_raw
...
#modify by XLYLHLWY-1 ang.gu 20190107 start
CUSTOM_MODEM = x610_h651
#modify by XLYLHLWY-1 ang.gu 20190107 end
...
# modify XWQEHWSYE-3772 by ge.ding 20180319 start
MTK_AUDIO_SPEAKER_PATH = int_lo_buf
# modify XWQEHWSYE-3772 by ge.ding 20180319 end
...
#SID: add XLYLHLWY-16 lijia.chen 20190425 start
MTK_BUILD_VERNO=X610B-H651AB-P-200805V370
#SID: add XLYLHLWY-16 lijia.chen 20190425 end
#SID: add XLYLHLWY-16 lijia.chen 20181009 start
FINGERPRINT_BUILD_VERNO=AB-200805V370
...
# BSP:modify KBSHLES-6 by ge.ding 20180920 start
MTK_DUAL_MIC_SUPPORT = no
# BSP:modify KBSHLES-6 by ge.ding 20180920 end
...
MTK_UCE_SUPPORT = no
MTK_UFS_OTP = no
#BSP:modify XLYLHLWY-2481 by zhijun.ye 20190305 start
MTK_ULTRA_DIMMING_SUPPORT = no
#BSP:modify XLYLHLWY-2481 by zhijun.ye 20190305 end
...
#BSP: add XLYLHLWY-2860 by xiaopan.ji 20180410 start
CUSTOM_KERNEL_UNCALI_ACC_SENSOR = yes
#BSP: add XLYLHLWY-2860 by xiaopan.ji 20180410 end
...
# add XWQEHWSYE-3772 by ge.ding 20180327 start
TRAN_AUDIOTEST_SUPPORT = yes
TRAN_NEW_LOOPBACK_TEST = yes
TRAN_DIRAC_PROP_SUPPORT = yes
TRAN_VOIP_BYPASS_DIRAC = yes
# add XWQEHWSYE-3772 by ge.ding 20180327 end
#BSP: add custom macro by wanghanfeng 20180830 start
CUSTOM_TRAN_PROJECT=tran_x610
CUSTOM_TRAN_BOM=tran_x610_a1
#BSP: add custom macro by wanghanfeng 20180830 end
...
#BSP: modify XLYLHLWY-3658 by tao.lan 20190506 start
CUSTOM_HAL_MSENSORLIB = akm09918_x610
#BSP: modify XLYLHLWY-3658 by tao.lan 20190506 end
...
#BSP: add XLYLHLWY-693 by xiaopan.ji for 20190116 start
...
#BSP: add XLYLHLWY-693 by xiaopan.ji for 20190116 end
#/*---------------------- sensor team setting end -------------------------------*/#
#BSP: modify XLYLHLWY-30 by tao.lan 20181030 end
#BSP:modify XLYLHLWY-745 by yongxian.wang 20190110 start
TRAN_CHARGING_KPOC_NUM_SITE_SUPPORT = yes
#BSP:modify XLYLHLWY-745 by yongxian.wang 20190110 end
...
#ITD:add XLYLHLWY-1590 by yang.li3 20190215 start
TRAN_FLASH_SLIDE_CONTROL=yes
#ITD:add XLYLHLWY-1590 by yang.li3 20190215 end
#ITD:modify RABHLYSP-11 by quan.chang 181127 start
CUSTOM_TRAN_PCBA = tran_pcba_h651
#ITD:modify RABHLYSP-11 by quan.chang 181127 end
#APP: Add by fuyu for XLYLHLWY-668 20190320 start
TRAN_MANUAL_GUIDE_SUPPORT = INFINIX-X610
#APP: Add by fuyu for XLYLHLWY-668 20190320 end
